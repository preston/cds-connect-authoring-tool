...
export default class cqlVisitor extends antlr4.tree.ParseTreeVisitor {
	...
	visitPointExtractorExpressionTerm(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	visitIdentifierOrFunctionIdentifier(ctx) {
	  return this.visitChildren(ctx);
	}
