...
export default class cqlListener extends antlr4.tree.ParseTreeListener {
	...
	enterDifferenceBetweenExpression(ctx) {
	}

	// Exit a parse tree produced by cqlParser#differenceBetweenExpression.
	exitDifferenceBetweenExpression(ctx) {
	}
